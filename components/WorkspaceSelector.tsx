...
export function WorkspaceUserMenu({ name }: { name: string }) {
  ...
  return (
    <div className="relative mt-5 inline-block" ref={menuRef}>
      ...
      {open && (
        <div
          className="absolute left-1/2 top-12 z-10 w-36 -translate-x-1/2 rounded-lg border border-border bg-surface p-1 text-left shadow-[0_8px_24px_rgb(17_24_39_/8%)]"
          role="menu"
        >
          <button
            type="button"
