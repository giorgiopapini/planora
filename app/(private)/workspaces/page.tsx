...
export default async function WorkspacesPage() {
  ...
  const [profile, workspaces] = await Promise.all([getCurrentProfile(), getWorkspaces()]);
      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-6 sm:p-8">
          <div className="text-center">
            <p className="text-4xl font-semibold tracking-tight">planora<span className="text-accent">.</span></p>
          ...
          <div className="mt-8"><WorkspaceList workspaces={workspaces} /></div>
        </CardContent>
      </Card>
    </main>
  );
