    ...
    <main className="min-h-screen overflow-hidden bg-page text-primary">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-4 pb-20 pt-16 sm:px-6 sm:pt-24 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:px-10 lg:pb-28 lg:pt-28">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-lg text-base leading-7 text-secondary sm:text-lg sm:leading-8">
              Planora brings projects, priorities, and people into one clear
              workspace—so your team always knows what matters next.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/signup">
                <Button size="lg">Start planning for free</Button>
              </Link>
              <Link
                href="#product"
            ...
            <div className="mt-10 flex items-center gap-4">
              ...
              <p className="text-xs leading-5 text-secondary">
                ...
                <span className="block text-tertiary">and more momentum.</span>
              </p>
            </div>
          </div>
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-0 px-4 sm:px-6 md:grid-cols-3 lg:px-10">
          <BenefitStat
            value="1 clear view"
            detail="for every project and priority"
          />
          <BenefitStat
            value="Less context switching"
            detail="from planning to progress"
            bordered
          />
          <BenefitStat
            value="Better balance"
            detail="across every team member"
          />
        </div>
      </section>

      <section id="product" className="scroll-mt-16 bg-page px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            eyebrow="A calmer way to work"
            title="Everything your team needs. Nothing it doesn’t."
            detail="Planora gives your team the structure to move with confidence, without burying the work under layers of process."
          />
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-3">
            <FeatureCard
              ...
              detail="Turn goals into organized projects, milestones, and focused tasks your team can actually act on."
              icon="path"
            />
            <FeatureCard
              number="02"
              title="See the whole picture"
              detail="Keep status, ownership, timelines, and recent activity visible in one shared workspace."
              icon="grid"
            />
            <FeatureCard
              number="03"
              title="Protect the team’s focus"
              detail="Spot overloaded people early and make thoughtful assignments before work gets stuck."
              icon="people"
            />
          </div>
        </div>
      ...
      <section className="bg-surface px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          <div>
            <Badge variant="success">Projects, in context</Badge>
            ...
            <p className="mt-5 max-w-lg text-sm leading-7 text-secondary sm:text-base">
              Give every project a home with clear ownership, simple status, and
              a timeline that keeps the next milestone in view.
            </p>
            <Link
              href="/signup"
            ...
            >
              Bring your projects together <span aria-hidden="true">→</span>
            </Link>
          </div>
      ...
      <section className="bg-page px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:gap-20">
          ...
          <div className="lg:pl-6">
            <Badge variant="success">People, balanced</Badge>
            <h2 className="mt-5 max-w-lg text-3xl font-semibold tracking-[-0.03em] sm:text-4xl">
              Keep the workload human.
            </h2>
            <p className="mt-5 max-w-lg text-sm leading-7 text-secondary sm:text-base">
              A busy team is not always a balanced team. See assignments at a
              glance, catch bottlenecks early, and keep good work moving without
              burning people out.
            </p>
      ...
      <section className="bg-surface px-4 py-24 sm:px-6 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            eyebrow="Built to stay out of the way"
            title="Simple enough to start. Thoughtful enough to stay."
            detail="The best workflow is the one your team actually uses. Planora keeps the interface familiar, the hierarchy clear, and the important details close."
          />
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            <QuoteCard
              quote="Planora gives us the visibility we need without making project management feel like another project."
              name="Maya Patel"
              role="Product lead"
            />
            <QuoteCard
              quote="The calmest place we have found to see what is moving, what is stuck, and who needs support."
              name="Jordan Lee"
        ...
        <div className="mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-2xl bg-tint-900 px-6 py-14 text-center sm:px-12 sm:py-20">
            ...
            <p className="relative mx-auto mt-5 max-w-xl text-sm leading-7 text-tint-100 sm:text-base">
              Start with a clearer view of your projects, your priorities, and
              your people.
            </p>
  ...
  return (
    <header className="relative z-20 border-b border-border bg-surface/90 backdrop-blur-sm">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-10">
        ...
        <nav className="hidden items-center gap-7 md:flex" aria-label="Landing page">
          <a
            href="#product"
        ...
        <div className="grid min-h-[390px] grid-cols-[48px_1fr] sm:grid-cols-[62px_1fr]">
          ...
          <div className="min-w-0 p-4 sm:p-6">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-[10px] text-secondary">Monday, September 7</p>
            ...
            <div className="mt-6 grid grid-cols-3 gap-2 sm:gap-3">
              <PreviewMetric label="Completed" value="24" accent />
              <PreviewMetric label="In progress" value="12" />
              <PreviewMetric label="Due soon" value="04" warning />
            </div>
            <div className="mt-5 grid gap-4 sm:grid-cols-[1.15fr_0.85fr]">
              <div className="rounded-xl border border-border p-3 sm:p-4">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <p className="text-xs font-semibold">Project health</p>
                    <p className="mt-1 text-[10px] text-secondary">Across all projects</p>
                  </div>
                  <span className="text-[10px] text-accent">Live</span>
                </div>
                <div className="mt-6 flex h-24 items-end gap-2 sm:h-28">
                  {[42, 58, 47, 72, 66, 84, 76, 92, 81, 96].map((height, index) => (
                    <div key={`project-health-bar-${index}`} className="flex-1 rounded-t-sm bg-tint-100">
                      <div
              ...
              <div className="rounded-xl border border-border p-3 sm:p-4">
                <p className="text-xs font-semibold">Team workload</p>
                <p className="mt-1 text-[10px] text-secondary">This week</p>
            ...
            <div className="mt-4 rounded-xl border border-border p-3 sm:p-4">
              ...
              <div className="mt-3 grid gap-2 sm:grid-cols-3">
                <MiniProject name="Website refresh" status="In progress" progress={72} />
                <MiniProject name="Spring campaign" status="On track" progress={48} />
                <MiniProject name="Hiring plan" status="Planning" progress={18} />
              </div>
            </div>
          </div>
        </div>
...
function ProjectOverviewPreview() {
  return (
    <Card className="overflow-hidden">
      <CardHeader className="border-b border-border bg-subtle p-4 sm:p-5">
        <div className="flex w-full items-center justify-between gap-3">
          <div>
            <p className="text-[10px] text-secondary">Projects / Website refresh</p>
            <CardTitle className="mt-1">Website refresh</CardTitle>
          </div>
        ...
        <div className="border-b border-border p-4 md:border-b-0 md:border-r sm:p-5">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-secondary">Product design</p>
            </div>
          </div>
          <div className="mt-7 grid grid-cols-2 gap-4">
            <div>
              <p className="text-[10px] text-secondary">Due date</p>
              <p className="mt-1 text-sm font-medium">Sep 30, 2026</p>
            </div>
            <div>
              <p className="text-[10px] text-secondary">Progress</p>
        ...
        <div className="p-4 sm:p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-secondary">September 1 – 30, 2026</p>
            </div>
            <span className="text-xs text-accent">Today</span>
          </div>
          <div className="mt-7 space-y-5">
            <TimelineRow label="Discovery and research" range="Sep 1 – 5" width="24%" color="bg-tint-900" />
            <TimelineRow label="Interface design" range="Sep 4 – 11" width="44%" color="bg-accent" />
            <TimelineRow label="Build and integration" range="Sep 10 – 19" width="56%" color="bg-tint-500" />
            <TimelineRow label="Launch" range="Sep 22" width="16%" color="bg-tint-300" milestone />
          </div>
        </div>
      </div>
    </Card>
  ...
  return (
    <Card className="overflow-hidden">
      <div className="flex items-start justify-between gap-4 border-b border-border p-4 sm:p-5">
        <div>
          <p className="text-sm font-semibold">Task assignments</p>
          <p className="mt-1 text-xs text-secondary">Daily workload by team member</p>
        </div>
        <div className="text-right">
          <p className="text-lg font-semibold">15</p>
          <p className="text-[10px] text-secondary">assigned this week</p>
        </div>
      </div>
      <div className="p-4 sm:p-5">
        <div className="grid grid-cols-[minmax(112px,0.9fr)_repeat(5,minmax(34px,1fr))] gap-1.5 text-center text-[10px] text-secondary sm:grid-cols-[minmax(150px,1fr)_repeat(5,minmax(42px,1fr))] sm:gap-2">
          <div className="px-2 py-2 text-left font-semibold uppercase tracking-[0.08em]">Team member</div>
          {['Mon', 'Tue', 'Wed', 'Thu', 'Fri'].map((day) => (
            <div key={day} className="py-2 font-semibold uppercase tracking-[0.08em]">
              {day}
            </div>
          ))}
          {demoAssignments.map((person, personIndex) => (
            <div key={person.name} className="contents">
              ...
              {[0, 1, 2, 3, 4].map((dayIndex) => {
                const count = Math.max(0, person.count - ((dayIndex + personIndex) % 4));
                return (
                  <div
                    ...
                    title={`${person.name}: ${count} assigned tasks`}
                  >
                    {count}
                  </div>
                );
...
function SectionIntro({
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="mt-5 text-sm leading-7 text-secondary sm:text-base">{detail}</p>
    </div>
  );
}
...
function BenefitStat({
  ...
  return (
    <div className={`py-6 md:px-8 md:py-8 ${bordered ? "border-y border-border md:border-x md:border-y-0" : ""}`}>
...
function PreviewMetric({
  ...
  return (
    <div className="rounded-lg border border-border p-2.5 sm:p-3">
      <div className={`mb-2 h-1.5 w-1.5 rounded-full ${warning ? "bg-warning" : accent ? "bg-accent" : "bg-tint-300"}`} />
      <p className="text-base font-semibold sm:text-lg">{value}</p>
      <p className="mt-0.5 truncate text-[9px] text-secondary sm:text-[10px]">{label}</p>
    </div>
  );
}
  ...
  return (
    <div className="grid grid-cols-[minmax(116px,0.9fr)_1.1fr] items-center gap-3 sm:grid-cols-[minmax(150px,0.8fr)_1.2fr] sm:gap-5">
      ...
      <div className="relative h-2 rounded-full bg-muted">
        <div className={`absolute inset-y-0 left-0 rounded-full ${color}`} style={{ width }} />
        {milestone && (
...
function MiniNavIcon({ active = false }: { active?: boolean }) {
  return <span className={`block h-4 w-full rounded ${active ? "bg-accent" : "bg-border-strong/70"}`} />;
}
...
function FeatureIcon({ type }: { type: "path" | "grid" | "people" }) {
  if (type === "path") {
    return (
      <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
        <path d="M5 18.5 9.5 14l3 2.5L19 8" strokeLinecap="round" strokeLinejoin="round" />
  ...
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
      ...
      <path d="M3.5 19c.5-3 2.3-4.5 5.5-4.5s5 1.5 5.5 4.5M14 15.5c2.7-.2 4.4 1 5 3.5" strokeLinecap="round" />
    </svg>
  );
}
    ...
    <footer className="border-t border-border bg-surface">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-8 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-10">
        ...
        <div className="flex flex-wrap items-center gap-5 text-xs text-secondary">
          <Link href="/signin" className="transition-colors duration-120 hover:text-primary">
            Sign in
          </Link>
          <Link href="/signup" className="transition-colors duration-120 hover:text-primary">
            Get started
          </Link>
          <span className="text-tertiary">Made for better work.</span>
        </div>
      </div>
    </footer>
  );
