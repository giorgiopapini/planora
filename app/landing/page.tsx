    ...
    <main className="min-h-screen bg-page">
      ...
      <section className="mx-auto flex max-w-4xl flex-col items-center px-4 py-24 text-center sm:px-6">
        ...
        <p className="mt-6 max-w-2xl text-base leading-7 text-secondary sm:text-lg">
          Planora keeps your projects, priorities, and people moving forward in
          one calm workspace.
        </p>
        ...
        <div className="mt-20 grid w-full gap-4 text-left sm:grid-cols-3">
          <Feature
            title="Plan clearly"
            detail="Turn ideas into focused, achievable projects."
          />
          <Feature
            title="Work together"
            detail="Give your team a shared view of what matters."
          />
          <Feature
            title="Keep moving"
            detail="See progress without adding more noise."
          />
        </div>
      </section>
    </main>
